  ...
  grunt.initConfig({
    ...
    csscomb: {
      all: {
        ...
        src: ['<%= config.cssDir %>*.css', 
              '<%= config.cssMainFileDir %><%= config.cssMainFileName %>.css',
              '!<%= config.cssDir %>jquery.background-video.min.css',
              '!<%= config.cssDir %>ie.css',
              '!<%= config.cssDir %>ie8.css'
              ],
        ext: '.css'
          ...
          sitecss: {
              ...
              files: {
                  'dist/css/site.min.css': [
                      'css/main.css',
                      'css/jquery.background-video.min.css']
              }
          }
      },
      ...
      uglify: {
          ...
          applib: {
              src: [
                  'js/jquery.background-video.min.js',
                  'js/main.js'
              ],
              dest: 'dist/js/app.js'
          }
...
//finally 
  ...
  //final build
  grunt.registerTask('dist', ['clean:temp', 'imgmin', 'cssbeauty', 'cssmin', 'uglify']);
