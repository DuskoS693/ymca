...
function adams_setup()
{
    ...
    add_image_size( '1240x700', 1240, 700, true );
    add_image_size( '304x304', 304, 304, false );


	// This theme uses wp_nav_menu() in two locations.
	register_nav_menus( array(
		'top'    => __( 'Top Menu', 'adams' ),
		'footer'    => __( 'Footer Menu', 'adams' ),
	) );
}
...
function adams_scripts()
{
    ...
    wp_localize_script('main', 'WPURLS', array( 'assetUrl' => get_bloginfo('template_url')  ));
}
...
function custom_sidebar() {
    register_sidebar(
        array (
            'name' => __( 'Primary Sidebar', 'delta' ),
            'id' => 'primary-sidebar',
            'description' => __( 'Custom Sidebar', 'delta' ),
            'before_widget' => '<div class="widget widget-content">',
            'after_widget' => "</div>",
...
function wpdocs_excerpt_more( $more ) {
    return '<div class="btn-holder"><a class="read-more-btn" href="'.get_the_permalink().'" rel="nofollow">Read More</a></div>';
}
